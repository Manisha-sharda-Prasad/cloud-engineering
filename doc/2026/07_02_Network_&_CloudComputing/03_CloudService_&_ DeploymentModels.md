...
* Provides raw, computing services VM, storage,and networking hardware.
* Manages: Physical hardware,data centers,virtualization, networking.
...
* Provides a pre-configured hardware and software platform, developers build, run, and manage applications only not building infrastructure.
