...
# Functions/ Methods: Methods are Functions, belong to object/classes : value.method_name()

# 🔸Convert Datatypes: Types():::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#type(), str()
print("-------------Convert Datatypes Types()-----------------")
text = "Hello"
numb = 20
print(type(text))
print(type(numb))
...
#upper(), lower(), strip(), replace(), '+', f-string, split(), '*', '[0]', '[start:end]', '[start:end:step]'
print("-------------Transformations/Modify-----------------")
# password = "  1238pas"
...
print(phoneNo.replace("+", "").replace(" ", "").replace("(", "")
      .replace(")", "").replace(" ", "").replace(" ", "").replace("-", ""))

#print this:: Name: Manisha |  Role: Data Engineer | Age:27
information = "800-Manisha, ( D@t@ Engineer ) ;; 27y  "
print(information.replace("800-", "Name: ").replace(",", " | ")
      .replace("(", "Role:").replace("D@t@ Engineer", "Data Engineer")
      .replace(") ;;", "|").replace("27", "Age:").replace("y  ", "27"))
...
# 🔸Cleaning/Conversion (white spaces):::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# lsript(), rstrip(), strip(), upper(), lower()
print("-------------Cleaning/Conversion-----------------")
